from venafi.tpp.plugins.api.aperture.aperture import Aperture
from venafi.tpp.plugins.api.websdk.endpoints.rights import _Rights
from venafi.tpp.api.authenticate import Authenticate as _OriginalAuthenticate
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from venafi.tpp.plugins.api.websdk.websdk import WebSDK
