...
from venafi.tpp.attributes.client_portal_base import ClientPortalBaseAttributes
from venafi.tpp.attributes.client_work_base import ClientWorkBaseAttributes
from venafi.tpp.attributes.x509_certificate_base import X509CertificateBaseAttributes
