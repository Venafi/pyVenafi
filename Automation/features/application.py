from enums.config import ConfigClass, ApplicationAttributes
...
class PKCS11(_ApplicationBase):
    ...
    def create(self, name: str, container: str, cryptoki_file_with_path: str, distribution_directory: str, openssl_config_file_with_path:str,
               ...
               connection_method: str = 'SSH', embed_sans_in_csr: bool = False, import_certificates_into_hsm: bool = False,
        ...
        attributes.update({
            ...
            pkcs11_attrs.hsm_embed_sans_in_csr: 1 if embed_sans_in_csr else 0,
            pkcs11_attrs.hsm_import_certificate: 1 if import_certificates_into_hsm else 0,
            ...
            pkcs11_attrs.hsm_reverse_subject_dn: 1 if reverse_subject_dn else 0
        })
