...
The |TPP Module| is a programmable interface that leverages the TPP WebSDK. It has layers: the API layer and the
...
.. code-block:: json

    {
        ...
        "vendor"     : "Venafi, Inc.",
        "description": "Application Integration for Venafi Python.",
...
``pip install git+https://github.com/Venafi/venafi.git#egg=venafi``

Uninstallation
--------------

``pip uninstall -y venafi``

.. note::
   The |TPP Module| is not versioned with TPP. In fact, it is meant to be compatible with all supported versions of TPP. There
