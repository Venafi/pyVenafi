from pyvenafi.tpp.api.api_base import generate_output, ApiField, WebSdkEndpoint, WebSdkOutputModel
from pyvenafi.tpp.plugins.api.websdk.models import rights
