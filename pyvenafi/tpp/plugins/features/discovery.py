...
if TYPE_CHECKING:
    from pyvenafi.tpp.plugins import Authenticate
from pyvenafi.tpp.api.websdk.models import config
from pyvenafi.tpp.features.bases.feature_base import feature
from pyvenafi.tpp.features.definitions.exceptions import UnexpectedValue
from pyvenafi.tpp.features.discovery import NetworkDiscovery as _NetworkDiscovery
from pyvenafi.tpp.plugins.api.aperture.enums.network_discovery import NetworkDiscovery as _NetworkDiscoveryProperties
