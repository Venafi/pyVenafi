...
class AppleTemplate(ObjectModel):
    ...
    pkix_parameter_set_policy: InfoValue[str] = ApiField(alias='PKIXParameterSetPolicy')
...
class AppleEnvironment(ObjectModel):
    ...
    key_use_flow_dn: str = ApiField(alias='KeyUseFlowDN')
    per_user: bool = ApiField(alias='PerUser')
    pkix_parameter_set: InfoValue[str] = ApiField(alias='PKIXParameterSet')
...
class CSPTemplate(ObjectModel):
    ...
    encryption_pkix_parameter_set_policy: InfoValue[str] = ApiField(alias='EncryptionPkixParameterSetPolicy')
    ...
    object_naming_pattern: str = ApiField(alias='ObjectNamingPattern')
    per_user: bool = ApiField(alias='PerUser')
    signing_pkix_parameter_set_policy: InfoValue[str] = ApiField(alias='SigningPkixParameterSetPolicy')
...
class CSPEnvironment(ObjectModel):
    ...
    encryption_pkix_parameter_set: InfoValue[str] = ApiField(alias='EncryptionPkixParameterSet')
    encryption_key_dn: str = ApiField(alias='EncryptionKeyDN')
    expiration: EnvironmentTemplateDetails[int] = ApiField(alias='Expiration')
    guid: str = ApiField(alias='Guid')
    id: int = ApiField(alias='Id')
    ip_address_restriction: Items[str] = ApiField(alias='IpAddressRestriction')
    key_storage_location: EnvironmentTemplateDetails[str] = ApiField(alias='KeyStorageLocation')
    ...
    per_user: bool = ApiField(alias='PerUser')
    signing_key_algorithm: EnvironmentTemplateDetails[str] = ApiField(alias='SigningKeyAlgorithm')
    signing_pkix_parameter_set: InfoValue[str] = ApiField(alias='SigningPkixParameterSet')
...
class GPGTemplate(ObjectModel):
    ...
    authentication_pkix_parameter_set_policy: InfoValue[str] = ApiField(alias='AuthenticationPkixParameterSetPolicy')
    description: str = ApiField(alias='Description')
    dn: str = ApiField(alias='Dn')
...
class GPGEnvironment(ObjectModel):
    ...
    authentication_key_dn: str = ApiField(alias='AuthenticationKeyDN')
    authentication_pkix_parameter_set: InfoValue[str] = ApiField(alias='AuthenticationPkixParameterSet')
    custom_field_attributes: Items[CustomFieldAttributes] = ApiField(alias='CustomFieldAttributes')
    dirty: bool = ApiField(alias='Dirty')
    disabled: bool = ApiField(alias='Disabled')
    dn: str = ApiField(alias='Dn')
    email: EnvironmentTemplateDetails[str] = ApiField(alias='Email', default_factory=list)
    encryption_key_algorithm: EnvironmentTemplateDetails[str] = ApiField(alias='EncryptionKeyAlgorithm')
    encryption_key_dn: str = ApiField(alias='EncryptionKeyDN')
    encryption_pkix_parameter_set: InfoValue[str] = ApiField(alias='EncryptionPkixParameterSet')
    expiration: EnvironmentTemplateDetails[int] = ApiField(alias='Expiration')
    ...
    id: int = ApiField(alias='Id')
    ip_address_restriction: Items[str] = ApiField(alias='IpAddressRestriction')
    is_issuer: InfoValue[bool] = ApiField(alias='IsIssuer')
    key_storage_location: EnvironmentTemplateDetails[str] = ApiField(alias='KeyStorageLocation')
    key_time_constraints: Items[str] = ApiField(alias='KeyTimeConstraints')
    key_use_flow_dn: str = ApiField(alias='KeyUseFlowDN')
    max_uses: int = ApiField(alias='MaxUses')
    per_user: bool = ApiField(alias='PerUser')
    real_name: EnvironmentTemplateDetails[str] = ApiField(alias='RealName')
    read_only: bool = ApiField(alias='ReadOnly')
    signing_key_algorithm: EnvironmentTemplateDetails[str] = ApiField(alias='SigningKeyAlgorithm')
    signing_key_dn: str = ApiField(alias='SigningKeyDN')
    signing_pkix_parameter_set: InfoValue[str] = ApiField(alias='SigningPkixParameterSet')
...
class KeyPairEnvironment(ObjectModel):
    ...
    key_storage_location: EnvironmentTemplateDetails[str] = ApiField(alias='KeyStorageLocation')
    key_time_constraints: Items[str] = ApiField(alias='KeyTimeConstraints')
    key_usage: EnvironmentTemplateDetails[str] = ApiField(alias='KeyUsage')
    key_use_flow_dn: str = ApiField(alias='KeyUseFlowDN')
    pkix_parameter_set: InfoValue[str] = ApiField(alias='PKIXParameterSet')
    status: int = ApiField(alias='Status')
    template_dn: str = ApiField(alias='TemplateDN')
