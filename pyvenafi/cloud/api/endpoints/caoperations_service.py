...
class _caoperations_service:
    ...
    class _v1(CloudApiEndpoint):
        def __init__(self, api_obj):
            ...
            self.certificateauthorities = self._certificateauthorities(api_obj=self._api_obj, url=f'{self._url}/certificateauthorities')
        ...
        class _certificateauthorities(CloudApiEndpoint):
            ...
            def get(self, includeSystemGenerated: bool, issuanceCertificateType: Literal['ALL', 'END_ENTITY', 'ISSUER']):
                data = {
                ...
                class _accounts(CloudApiEndpoint):
                    ...
                    class _ID(CloudApiEndpoint):
                        def __init__(self, *args, **kwargs):
                            ...
                            self.synchronisation = self._synchronisation(api_obj=self._api_obj, url=f'{self._url}/synchronisation')

                        def delete(self):
                            class Output(CloudApiOutputModel):
                                CertificateAuthorityAccountDeleteResponse: caoperations_service.CertificateAuthorityAccountDeleteResponse
                            return generate_output(output_cls=Output, response=self._delete(params={}), rc_mapping={200: 'CertificateAuthorityAccountDeleteResponse'})
                        ...
                        class _synchronisation(CloudApiEndpoint):
                            def put(self):
                                class Output(CloudApiOutputModel):
                                    ExtendedCertificateAuthorityAccountInformation: caoperations_service.ExtendedCertificateAuthorityAccountInformation
                                return generate_output(output_cls=Output, response=self._put(data={}), rc_mapping={200: 'ExtendedCertificateAuthorityAccountInformation'})
        ...
        class _certificaterequests(CloudApiEndpoint):
            def __init__(self, *args, **kwargs):
                ...
                self.approvalrequests = self._approvalrequests(api_obj=self._api_obj, url=f'{self._url}/approvalrequests')
                ...
                class _approval(CloudApiEndpoint):
                    ...
                    class _DECISION(CloudApiEndpoint):
                        def post(self, ApprovalDecisionRequest: caoperations_service.ApprovalDecisionRequest):
                            ...
                            return generate_output(output_cls=Output, response=self._post(data=data), rc_mapping={200: 'CertificateRequestInformation'})
                ...
                class _bulk(CloudApiEndpoint):
                    ...
                    class _DECISION(CloudApiEndpoint):
                        def post(self, BulkApprovalRequest: caoperations_service.BulkApprovalRequest):
                            ...
                            return generate_output(output_cls=Output, response=self._post(data=data), rc_mapping={201: 'BulkApprovalResponse'})

                    class _OPERATIONID(CloudApiEndpoint):
                        def get(self):
                            class Output(CloudApiOutputModel):
                                BulkApprovalStatusResponse: caoperations_service.BulkApprovalStatusResponse
                            return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'BulkApprovalStatusResponse'})
            ...
            class _approvalrequests(CloudApiEndpoint):
                ...
                class _ENTITYID(CloudApiEndpoint):
                    def get(self):
                        ...
                        return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'ApprovalRequestInformation'})
            ...
            class _approvalrules(CloudApiEndpoint):
                ...
                def get(self):
                    ...
                    return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'CertificateRequestApprovalRulesResponseOpenApi'})

                def post(self, CertificateRequestApprovalRulesRequest: caoperations_service.CertificateRequestApprovalRulesRequest):
                    ...
                    return generate_output(output_cls=Output, response=self._post(data=data), rc_mapping={201: 'CertificateRequestApprovalRuleOpenApi'})
                ...
                class _ID(CloudApiEndpoint):
                    def delete(self):
                        ...
                        return generate_output(output_cls=Output, response=self._delete(params={}), rc_mapping={200: 'CertificateRequestApprovalRuleDeleteResponseOpenApi'})

                    def get(self):
                        class Output(CloudApiOutputModel):
                            CertificateRequestApprovalRuleOpenApi: caoperations_service.CertificateRequestApprovalRuleOpenApi
                        return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'CertificateRequestApprovalRuleOpenApi'})

                    def put(self, CertificateRequestApprovalRulesUpdateRequest: caoperations_service.CertificateRequestApprovalRulesUpdateRequest):
                        data = {**CertificateRequestApprovalRulesUpdateRequest.dict()}

                        class Output(CloudApiOutputModel):
                            CertificateRequestApprovalRuleOpenApi: caoperations_service.CertificateRequestApprovalRuleOpenApi
                        return generate_output(output_cls=Output, response=self._put(data=data), rc_mapping={200: 'CertificateRequestApprovalRuleOpenApi'})
            ...
            class _revocations(CloudApiEndpoint):
                ...
                class _approvalrules(CloudApiEndpoint):
                    ...
                    def get(self):
                        ...
                        return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'CertificateRevocationApprovalRulesResponseOpenApi'})

                    def post(self, CertificateRevocationApprovalRulesRequest: caoperations_service.CertificateRevocationApprovalRulesRequest):
                        ...
                        return generate_output(output_cls=Output, response=self._post(data=data), rc_mapping={201: 'CertificateRevocationApprovalRuleOpenApi'})
                    ...
                    class _ID(CloudApiEndpoint):
                        def delete(self):
                            ...
                            return generate_output(output_cls=Output, response=self._delete(params={}), rc_mapping={200: 'CertificateRevocationApprovalRuleDeleteResponseOpenApi'})

                        def get(self):
                            class Output(CloudApiOutputModel):
                                CertificateRevocationApprovalRuleOpenApi: caoperations_service.CertificateRevocationApprovalRuleOpenApi
                            return generate_output(output_cls=Output, response=self._get(params={}), rc_mapping={200: 'CertificateRevocationApprovalRuleOpenApi'})

                        def put(self, CertificateRevocationApprovalRulesUpdateRequest: caoperations_service.CertificateRevocationApprovalRulesUpdateRequest):
                            data = {**CertificateRevocationApprovalRulesUpdateRequest.dict()}

                            class Output(CloudApiOutputModel):
                                CertificateRevocationApprovalRuleOpenApi: caoperations_service.CertificateRevocationApprovalRuleOpenApi
                            return generate_output(output_cls=Output, response=self._put(data=data), rc_mapping={200: 'CertificateRevocationApprovalRuleOpenApi'})
