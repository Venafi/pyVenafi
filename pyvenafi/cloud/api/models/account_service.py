...
class ApiKeyDetailedRequest(ObjectModel):
...
class ApiKeySimpleRequest(ObjectModel):
    key: UUID = ApiField(alias='key')
...
ApiKeyDetailedRequest.update_forward_refs()
...
ApiKeySimpleRequest.update_forward_refs()
