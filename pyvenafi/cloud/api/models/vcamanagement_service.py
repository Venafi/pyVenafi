...
class AwsCloudProviderInformation(ObjectModel):
    ...
    regions: List[Literal['af-south-1', 'ap-east-1', 'ap-northeast-1', 'ap-northeast-2', 'ap-northeast-3', 'ap-south-1', 'ap-south-2', 'ap-southeast-1', 'ap-southeast-2', 'ap-southeast-3', 'ap-southeast-4', 'ca-central-1', 'eu-central-1', 'eu-central-2',
                          'eu-north-1', 'eu-south-1', 'eu-south-2', 'eu-west-1', 'eu-west-2', 'eu-west-3', 'me-central-1', 'me-south-1', 'sa-east-1', 'us-east-1', 'us-east-2', 'us-gov-east-1', 'us-gov-west-1', 'us-west-1', 'us-west-2']] = ApiField(alias='regions', default_factory=list)
...
class ClientAuthenticationRequestOpenApi(ObjectModel):
    clientAuthentication: Union[JwtJwksAuthenticationOpenApi, JwtOidcAuthenticationOpenApi] = ApiField(alias='clientAuthentication')


class ClientAuthorizationInformation(ObjectModel):
    customClaimsAliases: CustomClaimsAliasesInformation = ApiField(alias='customClaimsAliases')
...
class ConfigurationCreateRequest(ObjectModel):
    ...
    clientAuthorization: ClientAuthorizationInformation = ApiField(alias='clientAuthorization')
    cloudProviders: CloudProvidersInformation = ApiField(alias='cloudProviders')
    minTlsVersion: Literal['TLS12', 'TLS13'] = ApiField(alias='minTlsVersion')
...
class CustomClaimsAliasesInformation(ObjectModel):
    allowAllPolicies: str = ApiField(alias='allowAllPolicies')
    allowedPolicies: str = ApiField(alias='allowedPolicies')
    configuration: str = ApiField(alias='configuration')
...
class ExtendedPolicyInformation(ObjectModel):
    ...
    creationDate: str = ApiField(alias='creationDate')
    extendedKeyUsages: Literal['ANY', 'CAPWAP_AC', 'CAPWAP_WTP', 'CLIENT_AUTH', 'CODE_SIGNING', 'DVCS', 'EAP_OVER_LAN', 'EAP_OVER_PPP', 'EMAIL_PROTECTION', 'IPSEC_ENDSYSTEM', 'IPSEC_IKE', 'IPSEC_IKE_INTERMEDIATE',
                               'IPSEC_TUNNEL', 'IPSEC_USER', 'OCSP_SIGNING', 'SBGP_CERT_AA_SERVER_AUTH', 'SCVP_CLIENT', 'SCVP_RESPONDER', 'SCVP_SERVER', 'SERVER_AUTH', 'SMARTCARD_LOGON', 'TIME_STAMPING'] = ApiField(alias='extendedKeyUsages')
    id: UUID = ApiField(alias='id')
...
class GoogleCloudProviderInformation(ObjectModel):
    ...
    regions: List[Literal['asia-east1', 'asia-east2', 'asia-northeast1', 'asia-northeast2', 'asia-northeast3', 'asia-south1', 'asia-south2', 'asia-southeast1', 'asia-southeast2', 'australia-southeast1', 'australia-southeast2', 'europe-central2', 'europe-north1', 'europe-southwest1', 'europe-west1', 'europe-west12', 'europe-west2', 'europe-west3',
                          'europe-west4', 'europe-west6', 'europe-west8', 'europe-west9', 'me-central1', 'me-west1', 'northamerica-northeast1', 'northamerica-northeast2', 'southamerica-east1', 'southamerica-west1', 'us-central1', 'us-east1', 'us-east4', 'us-east5', 'us-south1', 'us-west1', 'us-west2', 'us-west3', 'us-west4']] = ApiField(alias='regions', default_factory=list)
...
class IntermediateCertificateResponse(ObjectModel):
    intermediateCertificates: List[IntermediateCertificateInformation] = ApiField(alias='intermediateCertificates', default_factory=list)
...
class KeyAlgorithmInformation(ObjectModel):
    allowedValues: Literal['EC_ED25519', 'EC_P256', 'EC_P384', 'EC_P521', 'RSA_2048', 'RSA_3072', 'RSA_4096'] = ApiField(alias='allowedValues')
    defaultValue: Literal['EC_ED25519', 'EC_P256', 'EC_P384', 'EC_P521', 'RSA_2048', 'RSA_3072', 'RSA_4096'] = ApiField(alias='defaultValue')
...
class RegionInformation(ObjectModel):
    id: str = ApiField(alias='id')
    name: str = ApiField(alias='name')


class RegionsInformation(ObjectModel):
    aws: List[RegionInformation] = ApiField(alias='aws', default_factory=list)
    google: List[RegionInformation] = ApiField(alias='google', default_factory=list)


class RegionsResponse(ObjectModel):
    regions: RegionsInformation = ApiField(alias='regions')
...
class SubCaProviderCreateRequest(ObjectModel):
    ...
    keyAlgorithm: Literal['EC_ED25519', 'EC_P256', 'EC_P384', 'EC_P521', 'RSA_2048', 'RSA_3072', 'RSA_4096'] = ApiField(alias='keyAlgorithm')
...
class SubCaProviderPkcs11ConfigurationInformation(ObjectModel):
    ...
    partitionLabel: str = ApiField(alias='partitionLabel')
    partitionSerialNumber: str = ApiField(alias='partitionSerialNumber')
...
ClientAuthorizationInformation.update_forward_refs()
...
CustomClaimsAliasesInformation.update_forward_refs()
...
RegionInformation.update_forward_refs()
RegionsInformation.update_forward_refs()
RegionsResponse.update_forward_refs()
